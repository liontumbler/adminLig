...
@section('title', 'Error del servidor de páginas')
...
<div class="container container p-4 bg-dark" style="border-radius: 0px 0px 5px 5px;">
    <div class="row">
        ...
        <div class="col-lg-12">
            <h1 class="text-white" style="text-align: center; font-size: calc(4.375rem + 1.5vw);">500</h1>
        </div>
        <div class="col-lg-12">
            <h1 class="text-white" style="text-align: center;">Page Server Error</h1>
        </div>
        <div class="col-lg-12">
